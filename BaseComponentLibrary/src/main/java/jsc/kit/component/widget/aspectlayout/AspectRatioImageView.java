...
public class AspectRatioImageView extends AppCompatImageView implements IViewAttrDelegate, IAspect {
    ...
    public void initAttr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int baseWhat = a.getInt(R.styleable.AspectRatioImageView_base_what, 0);
        int aspectX = a.getInteger(R.styleable.AspectRatioImageView_aspect_x, 1);
        int aspectY = a.getInteger(R.styleable.AspectRatioImageView_aspect_y, 1);
        a.recycle();
